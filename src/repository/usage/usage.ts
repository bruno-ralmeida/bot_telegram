...
const data: DataFormat[] = [
  ...
  { 
    key: 'Como utilizar If?', 
    value: 'O comando if permite que uma parte do programa seja executada apenas quando uma condição for verdadeira. A sintaxe do comando ìf é a seguinte:' + 'if condição_do_if:' + '    # bloco executado se a condição for verdadeira' + '   comando_1' + '    comando_2' +  '   ...' + '    comando_m       # último comando do bloco' + 'comando_após_if'
  },
  { 
    key: 'Como utilizar if-else?', 
    value: 'Em várias ocasiões é necessário executar blocos de forma alternativa. Nesses casos, podemos utilizar o comando if-else, cuja sintaxe é a seguinte:' + 'if condição:' + '    # bloco contendo comandos a serem executados' + '   dentro_do_if_1' + '   dentro_do_if_2' + '   ...' + '    dentro_do_if_m' + '   else:' + '    dentro_do_else_1' + '   dentro_do_else_2' + '   ...' + '    dentro_do_else_n' + 'comando_apos_if'
  },
  { 
    key: 'Como utilizar for?', 
